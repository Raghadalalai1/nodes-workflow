...
function FlowChart() {
  ...
  const NodeInfo = ({ showNodeInfo, selectedNodeType }) => {
    const nodeTypes = useMemo(() => ({
      customNode: { title: 'The properties of Source Node:', title1: 'Original Source', titel2: 'Offline Source', description: 'This is a custom node voluptatibus officiis suscipit optio a, necessitatibus numquam commodi', style: { backgroundColor: 'white', borderColor: 'red', height: '83vh', top: '80px', color: 'red' }, icon:faLayerGroup },
      emailNode: { title: 'The properties of Email Node:', title1: 'Email Type', titel2: 'Email Address', description: 'This node handles email operations Provident cumque, atque quia quidem alias deleniti o', style: { backgroundColor: '#eaf4fc', borderColor: '#3498db', height: '69vh', top: '171px', color: '#3498db' },icon: faEnvelope },
      passwordNode: { title: 'The properties of Password Node:', title1: 'Password Length', titel2: 'Password Sequence', description: 'This node manages password-related actions Provident ', style: { backgroundColor: '#fde3cf', borderColor: '#e67e22', height: '55vh', top: '260px', color: '#e67e22' },icon:faEye },
      homeNode: { title: 'The properties of Home Node:', title1: 'Text Message', titel2: 'Person Name', description: 'This node represents the home or starting ', style: { backgroundColor: '#f5e6f7', borderColor: '#8e44ad', height: '41vh', top: '351px', color: '#8e44ad' },icon: faCommentSms },
      loginNode: { title: 'The properties of Login Node:', title1: 'Login', titel2: 'Logout', description: 'This node handles login functionality ', style: { backgroundColor: '#e8f8f5', borderColor: '#1abc9c', height: '32vh', top: '441px', color: '#1abc9c' },icon:faCircleCheck },
    }), []);
